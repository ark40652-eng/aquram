...
app.config['ADMIN_USERNAME'] = os.environ.get('ADMIN_USERNAME', 'aquram1')
app.config['ADMIN_PASSWORD'] = os.environ.get('ADMIN_PASSWORD', 'shoeworld1@2')
app.config['ADMIN_EMAIL'] = os.environ.get('ADMIN_EMAIL', 'ark40652@gmail.com')
...
def order_whatsapp(product_id):
    product = Product.query.get_or_404(product_id)
    msg = f'Hello Shoeworld Entebbe Baita, I want to order this shoe: {product.name}'
    from urllib.parse import quote
    wa_url = f'https://wa.me/256705951364?text={quote(msg)}'
